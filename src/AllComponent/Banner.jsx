...
const Banner = () => {
    return (
        <div style={{
        ...
        }} className='grid md:grid-cols-2 justify-center items-center mt-10 p-10 container mx-auto'>
            <div className='col-span-1 flex flex-col justify-center items-center space-y-5 '>
                ...
                <div><Link to={'https://drive.google.com/file/d/1xMbDQdbDscBmY_QxRtSF7pJenvDUMKrv/view?usp=sharing'} className=' border-2 border-blue-500 px-3 py-2 rounded-lg font-bold'>Download Resume</Link></div>
            </div>
